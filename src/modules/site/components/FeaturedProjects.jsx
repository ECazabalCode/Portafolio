...
function FeaturedProject() {
    ...
    return (
        <div className="px-4 pt-24 flex flex-col gap-10 overflow-hidden">
            ...
            <div className="sm:grid-cols-1 xl:grid-cols-3 grid gap-6">
                <ViewPortAnimator
                    inputAnimation="featured-projects-appear-from-left"
                    outAnimation="featured-projects-out-to-left">
                ...
                <ViewPortAnimator
                    inputAnimation='featured-projects-appear-from-top'
                    outAnimation='featured-projects-out-to-top'>
                    <Card style={{display: 'grid', gridTemplateRows: '40% 1fr 1fr', height: '25rem'}}>
                        <Card.Header style={{padding: 0}}>
                ...
                <ViewPortAnimator
                    inputAnimation="featured-projects-appear-from-right"
                    outAnimation="featured-projects-out-to-right">
                    <Card style={{display: 'grid', gridTemplateRows: '40% 1fr 1fr', height: '25rem'}}>
                        <Card.Header style={{padding: 0}}>
                            <img src={placeholder} alt="Mailswift"/>
                        </Card.Header>
